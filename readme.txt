* Directory structure *
  /startup   - Startup code needed by samples
  /ldscripts - Shared linker script pieces needed by samples
  /minimum   - based on the distributed minimum from the toolkit distribution
  /arduino   - port of Arduino 1.0.2 to LPC1114

  setup	     - startup script to setup pointers to environment
